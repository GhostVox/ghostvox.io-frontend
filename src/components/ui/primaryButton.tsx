export default function PrimaryButton({ text, action, children }: { text: string; action?: () => void, children?: React.ReactNode }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg"></div>
